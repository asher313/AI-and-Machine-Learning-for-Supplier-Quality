...
MODULES: dict[str, tuple[str, ...]] = {
    ...
    "sqm_ai.stats": ("numpy",),
    "sqm_ai.triage": (),
    "sqm_ai.anomalies": ("pandas", "numpy", "scipy",
                         "sqlalchemy", "structlog"),
    "sqm_ai.features": ("pandas", "numpy", "sklearn",
                        "sqlalchemy", "structlog"),
    "sqm_ai.extract": ("pandas", "yaml", "sqlalchemy",
                       "structlog"),
    ...
    "sqm_ai.build1.train": ("pandas", "numpy", "xgboost",
                            "sklearn", "scipy", "joblib"),
    "sqm_ai.build1.explain": ("pandas", "numpy", "shap"),
    "sqm_ai.build1.score_suppliers": ("pandas", "joblib",
                                      "sqlalchemy"),
    ...
    "sqm_ai.dl.ncr_finetune": ("torch", "transformers",
                               "datasets", "sklearn"),
    "sqm_ai.dl.ncr_zero_shot": ("torch", "transformers"),
    # Build 2 — Chapter 14
    "sqm_ai.cnc": (),
    "sqm_ai.cnc.features": ("numpy", "scipy"),
    "sqm_ai.cnc.train_stage1": ("numpy", "pandas", "xgboost",
                                "sklearn"),
    "sqm_ai.cnc.train_stage2": ("torch", "numpy"),
    "sqm_ai.cnc.export": ("torch", "numpy", "onnx",
                          "onnxruntime"),
    ...
    "sqm_ai.car.state": (),
    "sqm_ai.car.nodes": (),
    "sqm_ai.car.graph": ("langgraph",),
    "sqm_ai.car.validate": ("pydantic",),
